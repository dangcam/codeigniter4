...
async function export_word(title_group,title_month_year,title_report,myData){
	...
	var sourceHTML = header+("<h1 style=\"margin:0in;text-align:center;font-size:20px;font-family:VNI-Times;margin-right:2.85pt;\"><span style='font-size:16px;font-family:\"Times New Roman\",serif;'>MẪU ĐỀ CƯƠNG B&Aacute;O C&Aacute;O KẾT QUẢ HOẠT ĐỘNG ĐỊNH KỲ TH&Aacute;NG/QU&Yacute;/NĂM&nbsp;</span></h1>\n" +
		...
		"<p style=\"margin:0in;font-size:16px;font-family:VNI-Times;margin-top:3.0pt;margin-right:0in;margin-bottom:3.0pt;margin-left:28.35pt;text-align:justify;\"><span style='font-size:19px;font-family:\"Times New Roman\",serif;'>- Số lượng viên chức, người lao động: Viên chức: ;HĐLĐ: </span></p>\n" +
		"<p style=\"margin:0in;font-size:16px;font-family:VNI-Times;margin-top:3.0pt;margin-right:0in;margin-bottom:3.0pt;margin-left:28.35pt;text-align:justify;\"><span style='font-size:19px;font-family:\"Times New Roman\",serif;'><em> (Số lượng tiếp nhận viên chức; ký hợp đồng lao động mới; bổ nhiệm; miễn nhiệm; chấm dứt hợp đồng lao động; điều động, chuyển đổi vị trí công tác; nâng lương; khen thưởng, kỷ luật).</em>.</span></p>\n" +
